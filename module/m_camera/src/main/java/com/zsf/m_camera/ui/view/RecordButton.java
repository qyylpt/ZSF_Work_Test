...
public class RecordButton extends View implements View.OnTouchListener {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int innerColor = a.getColor(R.styleable.RecordButton_innerColor, getResources().getColor(R.color.innercircle));
        int externalColor = a.getColor(R.styleable.RecordButton_externalColor, getResources().getColor(R.color.externalcircle));
        int progressColor = a.getColor(R.styleable.RecordButton_progressColor, getResources().getColor(R.color.progress));
        a.recycle();
        ...
        mExternalPaint.setColor(externalColor);
        //初始化弧形画笔
    ...
    private void onActionEndAction() {
        ...
        if (mTouchTime < mMinRecordTime) {
            mRecordButtonListener.onLongClickFinish(RECORD_SHORT);
        } else {
            mRecordButtonListener.onLongClickFinish(NORMAL);
        }
    }
