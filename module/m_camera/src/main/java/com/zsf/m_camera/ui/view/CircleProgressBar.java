...
public class CircleProgressBar extends View
{
     ...
     * 普通的颜色
     */
    private int normalColor = Color.parseColor("#A5A5A5");
    /**
     * 已经走了的进度条颜色
     */
    private int progressColor = Color.parseColor("#FA9025");
    /**
     * 文字颜色
     */
     ...
     * 中心填充文字
     */
    private String centerText = "100%";
    private Paint fontPaint = null;
    /**
     * 填充式还是环形式
     */
    private Paint.Style progress_style = Paint.Style.STROKE;
    ...
    private void initPaint()
    {
        ...
        //设置画笔模式为描边
        mPaint.setStyle(progress_style);
        //设置画笔宽度为10px
